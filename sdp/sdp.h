/*
 *------------------------------------------------------------------
 * sdp.h  -- Header file for the generic SDP Parser
 *
...
/*
 * Macro for avoiding warnings against unused variables, function parameters, 
 * etc.
 * The "unused" attribute is not fully supported by GCC 2.95.3.
 * GCC will optimize away any code resulting from using this macro when 
 * compiling with -O1, -O2, etc.
 */
#define GCC_UNUSED(x)   (void)(x)
...
typedef enum {
    ...
    SDP_VERSION_LINE_NOT_FIRST,
    SDP_FIELD_VALUE_OVERFLOW,
    SDP_INVALID_BOOLEAN,
    SDP_INVALID_RTCP_PER_RCVR_BW_LINE,
    SDP_INVALID_FMTP_RTX_LINE,
    SDP_INVALID_RTPMAP_LINE,
    SDP_INVALID_CLOCK_IN_RTPMAP_LINE,
    SDP_INVALID_GROUP_LINE,
    SDP_INVALID_RTCP_LINE,
    SDP_INVALID_SRC_FILTER_LINE,
    SDP_INVALID_RTCP_UNICAST_LINE,
    SDP_INVALID_RTCP_FB_LINE,
    SDP_INVALID_RTCP_RSIZE_LINE,
    SDP_INVALID_RTCP_XR_LINE,
    SDP_MAX_RC
} sdp_result_e;
...
typedef enum {
    ...
    SDP_ATTR_CAT,       /* per RFC 4566 */
    SDP_ATTR_LABEL,     /* per RFC 4574 */
    SDP_ATTR_RTCP_FB,   /* per RFC 4585 */
    SDP_ATTR_RTCP_XR,   /* per RFC 3611 */
    SDP_ATTR_RTCP_RSIZE,/* per RFC 5506 */
    SDP_MAX_ATTR_TYPES,
    SDP_ATTR_INVALID
} sdp_attr_e;
...
typedef enum {
    ...
    /* These attribute parameters added for Cisco-specific */
    SDP_RTCP_PER_RCVR_BW,
...
typedef enum {
    SDP_FMTP_APT,
    SDP_FMTP_RTX_TIME,
    SDP_MAX_FMTP_RTP_RETRANS_VAL,
    SDP_FMTP_RTP_RETRANS_UNKNOWN_VAL
} sdp_fmtp_rtp_retrans_param_e;


/*
 * RTCP_XR_STAT_SUMMARY_SET_*
 *  Set a rtcp xr stat summary field flag
 */
#define SDP_RTCP_XR_STAT_LOSS_MASK           0x00000001
#define SDP_RTCP_XR_STAT_DUP_MASK            0x00000002
#define SDP_RTCP_XR_STAT_JITT_MASK           0x00000004
#define SDP_RTCP_XR_STAT_TTL_MASK            0x00000008
#define SDP_RTCP_XR_STAT_HL_MASK             0x00000010

#define SDP_RTCP_XR_SET_LOSS(ss)        ((ss) |= SDP_RTCP_XR_STAT_LOSS_MASK)
#define SDP_RTCP_XR_SET_DUP(ss)         ((ss) |= SDP_RTCP_XR_STAT_DUP_MASK)
#define SDP_RTCP_XR_SET_JITT(ss)        ((ss) |= SDP_RTCP_XR_STAT_JITT_MASK)
#define SDP_RTCP_XR_SET_TTL(ss)         ((ss) |= SDP_RTCP_XR_STAT_TTL_MASK)
#define SDP_RTCP_XR_SET_HL(ss)          ((ss) |= SDP_RTCP_XR_STAT_HL_MASK)

#define SDP_RTCP_XR_RESET_LOSS(ss)      ((ss) &= ~(SDP_RTCP_XR_STAT_LOSS_MASK))
#define SDP_RTCP_XR_RESET_DUP(ss)       ((ss) &= ~(SDP_RTCP_XR_STAT_DUP_MASK))
#define SDP_RTCP_XR_RESET_JITT(ss)      ((ss) &= ~(SDP_RTCP_XR_STAT_JITT_MASK))
#define SDP_RTCP_XR_RESET_TTL(ss)       ((ss) &= ~(SDP_RTCP_XR_STAT_TTL_MASK))
#define SDP_RTCP_XR_RESET_HL(ss)        ((ss) &= ~(SDP_RTCP_XR_STAT_HL_MASK))


/* rtcp-xr attribute parameters values for 
 * RTCP Extended Report */
typedef enum {
    SDP_RTCP_XR_PLR,            /* Loss RLE */
    SDP_RTCP_XR_PDR,            /* Duplicated RLE */
    SDP_RTCP_XR_PRT,            /* Packet Receipt Times */
    SDP_RTCP_XR_RTT,            /* Receiver Reference Time */
    SDP_RTCP_XR_SS,             /* Statistics Summary */
    SDP_RTCP_XR_VM,             /* VoIP Metrics */
    SDP_RTCP_XR_PERLR,          /* Post Error Repair Loss RLE */
    SDP_RTCP_XR_MA,             /* Multicast Acquisition Report */
    SDP_RTCP_XR_DC,             /* Diagnostic Counters Report */
    SDP_MAX_RTCP_XR_VAL,
    SDP_RTCP_XR_UNKNOWN_VAL
} sdp_rtcp_xr_param_e;
...
typedef enum {
    SDP_VIDEO_PIC_INVALID_VALUE,
    SDP_VIDEO_PIC_SIZE_CIF,
    SDP_VIDEO_PIC_SIZE_CIF4,
    SDP_VIDEO_PIC_SIZE_CIF16,
    SDP_VIDEO_PIC_SIZE_QCIF,
    SDP_VIDEO_PIC_SIZE_SQCIF
} sdp_video_picture_size;
...
extern const char *sdp_get_session_info(void *sdp_p);
...
extern const char *sdp_attr_get_sprtmap_encname(void *sdp_ptr, u16 level,
                                               u8 cap_num, u16 inst_num);
extern u16 sdp_attr_get_sprtmap_clockrate(void *sdp_ptr, u16 level,
                                         u8 cap_num, u16 inst_num);
...
extern sdp_result_e sdp_attr_set_fmtp_video_pic_size (void *sdp_ptr, u16 level, 
                                     u8 cap_num, u16 inst_num, 
...
extern sdp_result_e sdp_attr_set_fmtp_cpcf (void *sdp_ptr, u16 level, 
                                     u8 cap_num, u16 inst_num, 
                                     const char* cpcf);
extern sdp_result_e sdp_attr_set_fmtp_apt  (void *sdp_ptr, u16 level, 
                                            u8 cap_num, u16 inst_num, 
                                            u16 apt);

extern sdp_result_e sdp_attr_set_fmtp_rtx_time  (void *sdp_ptr, u16 level, 
                                                 u8 cap_num, u16 inst_num, 
                                                 u32 rtx_time);
...
extern int32 sdp_attr_get_fmtp_rtcp_per_rcvr_bw (void *sdp_ptr, u16 level,
                                                 u8 cap_num, u16 inst_num);

extern int32 sdp_attr_get_fmtp_video_pic_size (void *sdp_ptr, u16 level,
                            u8 cap_num, u16 inst_num, 
...
extern sdp_result_e sdp_attr_get_fmtp_profile_id(void *sdp_ptr, u16 level,
                                                u8 cap_num, u16 inst_num,
                                                const char **profile_id);
extern sdp_result_e sdp_attr_get_fmtp_param_sets(void *sdp_ptr, u16 level,
                                                u8 cap_num, u16 inst_num,
...
extern sdp_result_e sdp_attr_get_fmtp_max_br (void *sdp_ptr, u16 level,
                                       u8 cap_num, u16 inst_num, u32 *val);
extern sdp_result_e sdp_attr_fmtp_is_redundant_pic_cap (void *sdp_ptr, u16 level, 
                                                    u8 cap_num, 
                                                    u16 inst_num, 
                                                    tinybool *pic_cap);
extern sdp_result_e sdp_attr_fmtp_is_parameter_add (void *sdp_ptr, u16 level, 
                                                u8 cap_num, 
                                                u16 inst_num,
                                                tinybool *param_add);

extern const char* sdp_attr_get_fmtp_cpcf (void *sdp_ptr, u16 level,
                              u8 cap_num, u16 inst_num);
...
extern int32 sdp_attr_get_fmtp_apt (void *sdp_ptr, u16 level,
                                             u8 cap_num, u16 inst_num);
extern int32 sdp_attr_get_fmtp_rtx_time (void *sdp_ptr, u16 level,
                                             u8 cap_num, u16 inst_num);
...
extern u32 sdp_get_rtcp_port(void *sdp_ptr, u16 level, 
                             u8 cap_num, u16 inst_num);

extern sdp_result_e sdp_get_rtcp_conn_address(void *sdp_ptr, 
                                              u16 level, u8 cap_num,
                                              u16 inst_num, 
                                              sdp_nettype_e *nettype,
                                              sdp_addrtype_e *addrtype,
...
extern sdp_result_e sdp_get_rtcp_fb_nack_param (void *sdp_ptr, u16 level,
                                                u8 cap_num, u16 inst_num,
...
extern u16 sdp_attr_get_rtcp_xr_loss_rle(void *sdp_ptr, u16 level,
                                         u8 cap_num, u16 inst_num);

extern u16 sdp_attr_get_rtcp_xr_per_loss_rle(void *sdp_ptr, u16 level,
                                             u8 cap_num, u16 inst_num);

extern u32 sdp_attr_get_rtcp_xr_stat_summary(void *sdp_ptr, u16 level,
                                             u8 cap_num, u16 inst_num);
extern tinybool sdp_attr_get_rtcp_xr_multicast_acq(void *sdp_ptr, u16 level,
                                                   u8 cap_num, u16 inst_num);
extern tinybool sdp_attr_get_rtcp_rsize(void *sdp_ptr, u16 level,
                                        u8 cap_num, u16 inst_num);
extern tinybool sdp_attr_get_rtcp_xr_diagnostic_counters(void *sdp_ptr, 
                                                         u16 level,
                                                         u8 cap_num, 
                                                         u16 inst_num);
#endif /* _SDP_H_ */
