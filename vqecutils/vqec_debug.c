...
/*
 * String buffers that are suitable for debug or log use
 * (i.e., can be overwritten with the next debug or log statement).
 */
char s_log_str_large[VQEC_LOGMSG_BUFSIZE_LARGE];
